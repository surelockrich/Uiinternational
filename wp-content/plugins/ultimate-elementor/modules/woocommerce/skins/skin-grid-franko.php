...
class Skin_Grid_Franko extends Skin_Grid_Base {
	...
	public function view_cart() {
		echo '<div class="uael-notice-cart-outer">';
			echo '<div class="uael-notice-cart">';
				echo '<span class="uael-close-notice"></span>';
				echo '<div class="uael-text-notice">';
					echo '<div><b>"Modern Blazer"</b> has been added to your cart.</div>';
					echo '<a href="#cart-url" class="uael-forward">View Cart</a>';
				echo '</div>';
			echo '</div>';
		echo '</div>';
	}
